    ...
    try {
        ...
        const response = await fetch("https://api.nowpayments.io/v1/invoice", {
            ...
            body: JSON.stringify({
                ...
                price_currency: "USD",
                order_id: `bot-${item}`, 
                success_url: `https://bot-delivery-system.onrender.com/nowpayments-delivery?item=${item}`,  
...
app.post("/webhook", async (req, res) => {
    try {
        ...
        if (payment_status === "finished") {
            ...
            // ✅ Redirect NOWPayments users to a new bot delivery route
            return res.json({ success: true, redirectUrl: `https://bot-delivery-system.onrender.com/nowpayments-delivery?item=${item}` });
        } else {
...
// ✅ Route for Paystack & NOWPayments bot delivery (separate)
...
// ✅ NEW: NOWPayments Bot Delivery Route
